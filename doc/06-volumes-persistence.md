...
추적·백업이 불가능해지므로 **이름을 주는 습관**을 들인다. 보고서 13번에서 "명시적으로 만들어야 `docker volume ls` 로 추적·백업이 가능하다"고 적은 이유다.
...
>
> 그래서 보고서 13번에 "명시적으로 만들어야 `docker volume ls` 로 추적·백업이 가능하다"고 적었습니다.
